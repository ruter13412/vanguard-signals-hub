      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed text-sm">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li><strong className="text-foreground">Email Support:</strong> Send a cancellation request to <strong className="text-foreground">support@vanguard-signals.club</strong>. Include your account email address.</li>
          </ul>
          ...
          <p>For any questions about cancellation, contact us at <strong className="text-foreground">support@vanguard-signals.club</strong>. We typically respond within 24–48 hours.</p>
        </div>
      </div>
    </section>
  );
