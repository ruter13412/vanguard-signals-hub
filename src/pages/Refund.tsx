    ...
    <section className="section-padding">
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed text-sm">
          ...
          <p>If you believe you are eligible for a refund, please contact us at <strong className="text-foreground">support@vanguard-signals.space</strong> with:</p>
          <ul className="list-disc pl-5 space-y-2">
          ...
          <p>For any billing questions, reach out to <strong className="text-foreground">support@vanguard-signals.space</strong>.</p>
        </div>
      </div>
    </section>
  );
